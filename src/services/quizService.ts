...
export const quizService = {
  getExamQuizzesByUserId: async (userId: string): Promise<QuizResponse> => {
    try {
      const response = await axios.get(
        `${API_BASE_URL}/exam-quizz/get-all-exam-quizzes-by-user-id?userId=${userId}`,
        {
      ...
      console.error("Error fetching exam quizzes by user id:", error);
      throw error;
    }
  },
