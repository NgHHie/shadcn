    ...
    <Card className={cn("h-fit transition-colors duration-200", className)}>
      <CardHeader>
        ...
        <div className="flex flex-wrap gap-2 text-xs lg:text-sm">
          ...
          <Badge
            variant="outline"
            className="gap-1 text-primary border-primary/30 transition-colors duration-200"
          >
            ...
            return (
              <Button
                ...
                className={cn(
                  ...
                  isActive &&
                    "ring-2 ring-ring ring-offset-1 lg:ring-offset-2 bg-primary text-primary-foreground",
                  // Trạng thái đã làm
                  question.isAnswered &&
                    !isActive &&
