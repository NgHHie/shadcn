...
```
cd existing_repo
git remote add origin https://gitlab.com/dblab-system/dblab-web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dblab-system/dblab-web/-/settings/integrations)
